...
public class LoginActivity extends AppCompatActivity {
    ...
    public void login() {
        ...
        LoginReqDTO requestData = new LoginReqDTO();
        requestData.setUname(email);
        requestData.setPassword(password);

        // TODO: Implement your own authentication logic here.
        EndPoints serviceCall = ServiceGenerator.createService(EndPoints.class);

        Call<LoginResDTO> call = serviceCall.loginUser(requestData);
        call.enqueue(new Callback<LoginResDTO>() {
            @Override
